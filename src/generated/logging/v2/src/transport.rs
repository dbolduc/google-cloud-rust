...
impl super::stub::LoggingServiceV2 for LoggingServiceV2 {
    async fn delete_log(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.log_name)?;
                if !matches(
                    arg1,
                    &[
...
impl super::stub::ConfigServiceV2 for ConfigServiceV2 {
    ...
    async fn create_bucket_async(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/buckets:createAsync", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn update_bucket_async(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:updateAsync", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn get_sink(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.sink_name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::SingleWildcard,
    ...
    async fn list_exclusions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/exclusions", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn get_cmek_settings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/cmekSettings", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
...
impl super::stub::MetricsServiceV2 for MetricsServiceV2 {
    ...
    async fn get_log_metric(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.metric_name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
