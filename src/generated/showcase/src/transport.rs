...
impl super::stub::Compliance for Compliance {
    async fn repeat_data_body(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/repeat:body",)))
            .ok_or_else(|| {
    ...
    async fn repeat_data_body_info(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/repeat:bodyinfo",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn repeat_data_query(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/repeat:query",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn repeat_data_body_put(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/repeat:bodyput",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn repeat_data_body_patch(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/repeat:bodypatch",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn get_enum(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/compliance/enum",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn list_locations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}/locations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn set_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:setIamPolicy", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn get_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:getIamPolicy", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn test_iam_permissions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:testIamPermissions", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn list_operations(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/operations",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn cancel_operation(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:cancel", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::Echo for Echo {
    async fn echo(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:echo",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn echo_error_details(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:error-details",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn fail_echo_with_details(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:failWithDetails",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn paged_expand(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:pagedExpand",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn paged_expand_legacy(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:pagedExpandLegacy",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn paged_expand_legacy_mapped(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:pagedExpandLegacyMapped",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn wait(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:wait",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn block(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/echo:block",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
...
impl super::stub::Identity for Identity {
    async fn create_user(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/users",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn update_user(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.user.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("users"),
...
impl super::stub::Messaging for Messaging {
    async fn create_room(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/rooms",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn update_room(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.room.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("rooms"),
    ...
    async fn create_blurb(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}/blurbs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn update_blurb(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.blurb.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("rooms"),
    ...
    async fn search_blurbs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}/blurbs:search", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
...
impl super::stub::SequenceService for SequenceService {
    async fn create_sequence(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/sequences",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn create_streaming_sequence(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/streamingSequences",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
...
impl super::stub::Testing for Testing {
    async fn create_session(
        ...
        let path = None
            .or_else(|| Some(format!("/v1beta1/sessions",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn report_session(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:report", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_tests(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}/tests", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn verify_test(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1beta1/{}:check", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
