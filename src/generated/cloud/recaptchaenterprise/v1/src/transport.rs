...
impl super::stub::RecaptchaEnterpriseService for RecaptchaEnterpriseService {
    async fn create_assessment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/assessments", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn retrieve_legacy_secret_key(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:retrieveLegacySecretKey", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_key(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.key.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn add_ip_override(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:addIpOverride", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_ip_override(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeIpOverride", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_ip_overrides(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:listIpOverrides", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_firewall_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/firewallpolicies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reorder_firewall_policies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/firewallpolicies:reorder", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_related_account_groups(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/relatedaccountgroups", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::ListRelatedAccountGroupMembershipsResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/memberships", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
