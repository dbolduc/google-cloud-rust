...
impl super::stub::DeveloperConnect for DeveloperConnect {
    async fn list_connections(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/connections", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn create_git_repository_link(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/gitRepositoryLinks", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_read_write_token(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.git_repository_link)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:fetchReadWriteToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.git_repository_link),
                        "git_repository_link",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn fetch_read_token(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchReadToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_linkable_git_repositories(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchLinkableGitRepositories", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_git_hub_installations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchGitHubInstallations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_git_refs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchGitRefs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
