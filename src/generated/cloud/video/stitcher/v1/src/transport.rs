...
impl super::stub::VideoStitcherService for VideoStitcherService {
    ...
    async fn create_vod_session(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vodSessions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_vod_stitch_details(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vodStitchDetails", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_vod_ad_tag_details(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vodAdTagDetails", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_live_ad_tag_details(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/liveAdTagDetails", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_slate(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.slate.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn create_live_session(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/liveSessions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_live_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/liveConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_vod_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vodConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
