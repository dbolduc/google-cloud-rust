        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.company.as_ref()).map(|m| &m.name),
                        "company.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
...
impl super::stub::Completion for Completion {
    async fn complete_query(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.tenant)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v4/{}:completeQuery", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_client_event(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/clientEvents", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::JobService for JobService {
    ...
    async fn batch_create_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/jobs:batchCreate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_job(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.job.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn batch_update_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/jobs:batchUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_delete_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/jobs:batchDelete", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn search_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/jobs:search", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn search_jobs_for_alert(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v4/{}/jobs:searchForAlert", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.tenant.as_ref()).map(|m| &m.name),
                        "tenant.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
