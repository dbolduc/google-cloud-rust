...
impl super::stub::DataCatalog for DataCatalog {
    async fn search_catalog(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/catalog:search",)))
            .ok_or_else(|| {
    ...
    async fn create_entry_group(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/entryGroups", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_entry(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.entry.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn lookup_entry(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/entries:lookup",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn modify_entry_overview(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:modifyEntryOverview", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn modify_entry_contacts(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:modifyEntryContacts", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_tag_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/tagTemplates", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reconcile_tags(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/tags:reconcile", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_entries(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/entries:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn retrieve_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:retrieveConfig", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn retrieve_effective_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:retrieveEffectiveConfig", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn create_taxonomy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/taxonomies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_policy_tag(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/policyTags", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_taxonomies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/taxonomies:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn export_taxonomies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/taxonomies:export", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
