...
impl super::stub::BackupForGKE for BackupForGKE {
    async fn create_backup_plan(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupPlans", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn create_backup_channel(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupChannels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_backup_plan_bindings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupPlanBindings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_volume_backups(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/volumeBackups", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_restore_plan(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/restorePlans", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_restore_channel(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/restoreChannels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_restore_plan_bindings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/restorePlanBindings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_volume_restores(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/volumeRestores", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn get_backup_index_download_url(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.backup)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:getBackupIndexDownloadUrl", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
