...
impl super::stub::DocumentProcessorService for DocumentProcessorService {
    ...
    async fn batch_process_documents(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:batchProcess", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn fetch_processor_types(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchProcessorTypes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_processor_types(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/processorTypes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_processors(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/processors", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn train_processor_version(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/processorVersions:train", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_processor_versions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/processorVersions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn set_default_processor_version(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.processor)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:setDefaultProcessorVersion", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn review_document(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.human_review_config)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:reviewDocument", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn evaluate_processor_version(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.processor_version)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:evaluateProcessorVersion", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_evaluations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/evaluations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_locations(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/uiv1beta3/{}/locations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn cancel_operation(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/uiv1beta3/{}:cancel", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
