...
impl super::stub::MigrationCenter for MigrationCenter {
    ...
    async fn update_asset(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.asset.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn batch_update_assets(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/assets:batchUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_delete_assets(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/assets:batchDelete", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn report_asset_frames(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/assets:reportAssetFrames", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn aggregate_assets_values(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/assets:aggregateValues", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_import_job(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/importJobs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_import_data_files(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/importDataFiles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_assets_from_group(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeAssets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_error_frames(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/errorFrames", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_preference_sets(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/preferenceSets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_report_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/reportConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
