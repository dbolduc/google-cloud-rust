    ...
    async fn create_data_access_label(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/dataAccessLabels", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn create_data_access_scope(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/dataAccessScopes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_watchlists(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/watchlists", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_reference_lists(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/referenceLists", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_retrohunt(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/retrohunts", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
