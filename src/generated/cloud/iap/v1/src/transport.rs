    ...
    async fn get_iap_settings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:iapSettings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn validate_iap_attribute_expression(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:validateAttributeExpression", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_tunnel_dest_groups(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/destGroups", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_identity_aware_proxy_client(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/identityAwareProxyClients", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reset_identity_aware_proxy_client_secret(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resetSecret", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
