    ...
    async fn batch_annotate_images(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/v1/{}/images:annotate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn batch_annotate_files(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/v1/{}/files:annotate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn async_batch_annotate_images(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/v1/{}/images:asyncBatchAnnotate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn async_batch_annotate_files(
        ...
        let path = None
            ...
            .or_else(|| {
                ...
                Some(format!("/v1/{}/files:asyncBatchAnnotate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_product_set(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/productSets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_reference_image(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/referenceImages", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_product_to_product_set(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:addProduct", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_product_from_product_set(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeProduct", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_product_sets(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/productSets:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn purge_products(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/products:purge", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
