...
impl super::stub::ImageAnnotator for ImageAnnotator {
    async fn batch_annotate_images(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v1/images:annotate",);
    ...
    async fn batch_annotate_files(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v1/files:annotate",);
    ...
    async fn async_batch_annotate_images(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v1/images:asyncBatchAnnotate",);
    ...
    async fn async_batch_annotate_files(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v1/files:asyncBatchAnnotate",);
