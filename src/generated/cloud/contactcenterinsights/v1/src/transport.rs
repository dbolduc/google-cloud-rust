...
impl super::stub::ContactCenterInsights for ContactCenterInsights {
    async fn create_conversation(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversations", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn upload_conversation(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversations:upload", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn bulk_analyze_conversations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversations:bulkAnalyze", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn bulk_delete_conversations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversations:bulkDelete", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn ingest_conversations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversations:ingest", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn export_insights_data(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/insightsdata:export", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_issue_model(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/issueModels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_issue_model(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/issueModels:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_issue(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.issue.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn calculate_issue_model_stats(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.issue_model)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:calculateIssueModelStats", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_phrase_matcher(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/phraseMatchers", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn calculate_stats(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.location)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}/conversations:calculateStats", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.location)?;
                if !matches(
                ...
                Some(format!("/v1/{}:calculateStats", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_analysis_rule(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/analysisRules", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn initialize_encryption_spec(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:initialize", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_view(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.view.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn query_metrics(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:queryMetrics", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.location)?;
                if !matches(
    ...
    async fn create_qa_question(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/qaQuestions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_qa_scorecard(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/qaScorecards", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn tune_qa_scorecard_revision(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:tuneQaScorecardRevision", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_feedback_label(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/feedbackLabels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_all_feedback_labels(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:listAllFeedbackLabels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn bulk_upload_feedback_labels(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:bulkUploadFeedbackLabels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn bulk_download_feedback_labels(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:bulkDownloadFeedbackLabels", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
