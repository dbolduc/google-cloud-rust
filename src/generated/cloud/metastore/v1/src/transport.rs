...
impl super::stub::DataprocMetastore for DataprocMetastore {
    ...
    async fn list_metadata_imports(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/metadataImports", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn export_metadata(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.service)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn query_metadata(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:queryMetadata", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn move_table_to_database(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:moveTableToDatabase", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn alter_metadata_resource_location(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:alterLocation", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_federations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/federations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
