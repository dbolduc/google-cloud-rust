...
impl super::stub::Domains for Domains {
    async fn search_domains(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/registrations:searchDomains", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn register_domain(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/registrations:register", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn transfer_domain(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/registrations:transfer", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_registrations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/registrations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn configure_management_settings(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.registration)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:configureManagementSettings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn configure_dns_settings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:configureDnsSettings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn configure_contact_settings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:configureContactSettings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn retrieve_authorization_code(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:retrieveAuthorizationCode", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reset_authorization_code(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resetAuthorizationCode", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
