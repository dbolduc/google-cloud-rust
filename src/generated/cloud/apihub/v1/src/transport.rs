...
impl super::stub::ApiHub for ApiHub {
    ...
    async fn update_api(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.api.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.api.as_ref()).map(|m| &m.name),
                        "api.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn update_spec(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.spec.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.spec.as_ref()).map(|m| &m.name),
                        "spec.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn create_attribute(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/attributes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn search_resources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:searchResources", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_external_api(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/externalApis", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_dependency(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/dependencies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_host_project_registration(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/hostProjectRegistrations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_api_hub_instance(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/apiHubInstances", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn lookup_api_hub_instance(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/apiHubInstances:lookup", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_runtime_project_attachment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/runtimeProjectAttachments", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn lookup_runtime_project_attachment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:lookupRuntimeProjectAttachment", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
