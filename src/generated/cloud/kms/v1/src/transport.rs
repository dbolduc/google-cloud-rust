    ...
    async fn create_key_handle(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/keyHandles", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn show_effective_autokey_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:showEffectiveAutokeyConfig", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_ekm_connections(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/ekmConnections", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn verify_connectivity(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:verifyConnectivity", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_crypto_keys(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/cryptoKeys", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_crypto_key_versions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/cryptoKeyVersions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_crypto_key_version(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/cryptoKeyVersions:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_crypto_key_primary_version(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:updatePrimaryVersion", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn raw_encrypt(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:rawEncrypt", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn raw_decrypt(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:rawDecrypt", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn asymmetric_sign(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:asymmetricSign", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn asymmetric_decrypt(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:asymmetricDecrypt", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_random_bytes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateRandomBytes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
