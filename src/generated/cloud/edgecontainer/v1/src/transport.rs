...
impl super::stub::EdgeContainer for EdgeContainer {
    ...
    async fn generate_access_token(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.cluster)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:generateAccessToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_offline_credential(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateOfflineCredential", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_vpn_connections(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vpnConnections", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
