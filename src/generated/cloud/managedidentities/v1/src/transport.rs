    ...
    async fn reset_admin_password(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resetAdminPassword", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.domain.as_ref()).map(|m| &m.name),
                        "domain.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn attach_trust(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:attachTrust", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reconfigure_trust(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:reconfigureTrust", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn detach_trust(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:detachTrust", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn validate_trust(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:validateTrust", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
