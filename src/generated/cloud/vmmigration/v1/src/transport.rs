...
impl super::stub::VmMigration for VmMigration {
    ...
    async fn fetch_inventory(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.source)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:fetchInventory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_utilization_reports(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/utilizationReports", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_datacenter_connectors(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/datacenterConnectors", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn upgrade_appliance(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.datacenter_connector)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:upgradeAppliance", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.datacenter_connector),
    ...
    async fn create_migrating_vm(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/migratingVms", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn start_migration(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.migrating_vm)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:startMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn resume_migration(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resumeMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn pause_migration(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:pauseMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn finalize_migration(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:finalizeMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_cutover_job(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/cutoverJobs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_group(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.group.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn add_group_migration(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.group)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:addGroupMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_group_migration(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeGroupMigration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_target_projects(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/targetProjects", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_replication_cycles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/replicationCycles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
