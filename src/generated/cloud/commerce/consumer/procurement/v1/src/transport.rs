    ...
    async fn enumerate_licensed_users(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:enumerateLicensedUsers", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn place_order(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/orders:place", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
