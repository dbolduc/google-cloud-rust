    ...
    async fn list_management_servers(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/managementServers", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn fetch_usable_backup_vaults(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupVaults:fetchUsable", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_data_sources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/dataSources", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_backup_plan_association(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupPlanAssociations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn trigger_backup(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:triggerBackup", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
