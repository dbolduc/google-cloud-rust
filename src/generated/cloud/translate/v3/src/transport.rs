    ...
    async fn translate_text(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:translateText", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn romanize_text(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:romanizeText", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn detect_language(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:detectLanguage", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn get_supported_languages(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/supportedLanguages", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn translate_document(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:translateDocument", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_translate_text(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:batchTranslateText", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_translate_document(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:batchTranslateDocument", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_glossary(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/glossaries", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_glossary_entries(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/glossaryEntries", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_adaptive_mt_dataset(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/adaptiveMtDatasets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn adaptive_mt_translate(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:adaptiveMtTranslate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_adaptive_mt_file(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:importAdaptiveMtFile", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_adaptive_mt_files(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/adaptiveMtFiles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_adaptive_mt_sentences(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}/adaptiveMtSentences", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn import_data(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:importData", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn export_data(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:exportData", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
