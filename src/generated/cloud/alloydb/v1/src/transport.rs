    ...
    async fn restore_from_cloud_sql(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/clusters:restoreFromCloudSQL", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn switchover_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:switchover", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn restore_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/clusters:restore", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_secondary_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/clusters:createsecondary", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_secondary_instance(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/instances:createsecondary", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_create_instances(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/instances:batchCreate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn inject_fault(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:injectFault", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn execute_sql(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:executeSql", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_supported_database_flags(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/supportedDatabaseFlags", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_client_certificate(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateClientCertificate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn get_connection_info(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/connectionInfo", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
