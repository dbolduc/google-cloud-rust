...
impl super::stub::AnalyticsService for AnalyticsService {
    async fn export_analytics_metrics(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.catalog)?;
                if !matches(
                    arg1,
                    &[
                ...
                Some(format!("/v2/{}:exportAnalyticsMetrics", arg1,))
            })
            .ok_or_else(|| {
...
impl super::stub::CatalogService for CatalogService {
        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.catalog.as_ref()).map(|m| &m.name),
                        "catalog.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn set_default_branch(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:setDefaultBranch", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn get_default_branch(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:getDefaultBranch", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_catalog_attribute(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.attributes_config)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:addCatalogAttribute", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.attributes_config),
                        "attributes_config",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn remove_catalog_attribute(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:removeCatalogAttribute", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn replace_catalog_attribute(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:replaceCatalogAttribute", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn complete_query(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:completeQuery", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_completion_data(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/completionData:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.control.as_ref()).map(|m| &m.name),
                        "control.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn update_generative_questions_feature_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/generativeQuestionFeature", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_generative_question_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/generativeQuestions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_generative_question_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/generativeQuestion", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::BatchUpdateGenerativeQuestionConfigsResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/generativeQuestion:batchUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::ModelService for ModelService {
    ...
    async fn update_model(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.model.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.model.as_ref()).map(|m| &m.name),
                        "model.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
...
impl super::stub::PredictionService for PredictionService {
    async fn predict(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.placement)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
...
impl super::stub::ProductService for ProductService {
    ...
    async fn purge_products(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/products:purge", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_products(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/products:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn set_inventory(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:setInventory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_fulfillment_places(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.product)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:addFulfillmentPlaces", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_fulfillment_places(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:removeFulfillmentPlaces", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_local_inventories(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:addLocalInventories", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_local_inventories(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:removeLocalInventories", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::ServingConfigService for ServingConfigService {
    async fn create_serving_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/servingConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_control(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.serving_config)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:addControl", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_control(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:removeControl", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn write_user_event(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/userEvents:write", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn collect_user_event(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/userEvents:collect", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn purge_user_events(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/userEvents:purge", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_user_events(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/userEvents:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn rejoin_user_events(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/userEvents:rejoin", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
