    ...
    async fn create_transfer_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/transferConfigs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn schedule_transfer_runs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:scheduleRuns", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn start_manual_transfer_runs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:startManualRuns", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_transfer_logs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/transferLogs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn check_valid_creds(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:checkValidCreds", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn enroll_data_sources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:enrollDataSources", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn unenroll_data_sources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:unenrollDataSources", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
