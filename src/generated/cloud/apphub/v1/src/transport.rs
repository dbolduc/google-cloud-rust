    ...
    async fn lookup_service_project_attachment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:lookupServiceProjectAttachment", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_service_project_attachments(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceProjectAttachments", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn detach_service_project_attachment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:detachServiceProjectAttachment", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_discovered_services(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/discoveredServices", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn lookup_discovered_service(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/discoveredServices:lookup", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_discovered_workloads(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/discoveredWorkloads", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn lookup_discovered_workload(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/discoveredWorkloads:lookup", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_applications(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/applications", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
