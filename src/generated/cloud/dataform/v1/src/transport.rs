...
impl super::stub::Dataform for Dataform {
    ...
    ) -> Result<gax::response::Response<crate::model::QueryRepositoryDirectoryContentsResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:queryDirectoryContents", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_repository_history(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchHistory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::ComputeRepositoryAccessTokenStatusResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:computeAccessTokenStatus", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_remote_branches(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchRemoteBranches", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_workspaces(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/workspaces", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn install_npm_packages(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.workspace)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:installNpmPackages", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_file_git_statuses(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchFileGitStatuses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_git_ahead_behind(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchGitAheadBehind", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_file_diff(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchFileDiff", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn search_files(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:searchFiles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn make_directory(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:makeDirectory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_directory(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeDirectory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn move_directory(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:moveDirectory", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn remove_file(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:removeFile", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_release_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/releaseConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_compilation_results(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/compilationResults", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_workflow_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/workflowConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_workflow_invocations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/workflowInvocations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
