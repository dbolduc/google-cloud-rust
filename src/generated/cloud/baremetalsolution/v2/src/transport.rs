...
impl super::stub::BareMetalSolution for BareMetalSolution {
    ...
    async fn enable_interactive_serial_console(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:enableInteractiveSerialConsole", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn disable_interactive_serial_console(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:disableInteractiveSerialConsole", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn detach_lun(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.instance)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn resize_volume(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.volume)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn list_network_usage(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/networks:listNetworkUsage", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn restore_volume_snapshot(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.volume_snapshot)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:restoreVolumeSnapshot", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_provisioning_quotas(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/provisioningQuotas", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn submit_provisioning_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/provisioningConfigs:submit", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_provisioning_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/provisioningConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
