    ...
    async fn list_lb_traffic_extensions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/lbTrafficExtensions", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_lb_route_extensions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/lbRouteExtensions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::NetworkServices for NetworkServices {
    async fn list_endpoint_policies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/endpointPolicies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_grpc_routes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/grpcRoutes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_http_routes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/httpRoutes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_service_bindings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceBindings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_mesh(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.mesh.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn list_service_lb_policies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceLbPolicies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_gateway_route_views(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/routeViews", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
