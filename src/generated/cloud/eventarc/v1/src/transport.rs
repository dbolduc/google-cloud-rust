    ...
    async fn list_channel_connections(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/channelConnections", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_message_buses(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/messageBuses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_message_bus_enrollments(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:listEnrollments", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_enrollments(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/enrollments", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_google_api_sources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/googleApiSources", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
