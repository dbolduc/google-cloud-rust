...
impl super::stub::Speech for Speech {
    async fn create_recognizer(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/recognizers", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn recognize(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.recognizer)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn batch_recognize(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:batchRecognize", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_custom_class(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/customClasses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_phrase_set(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/phraseSets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
