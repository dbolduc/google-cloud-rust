...
impl super::stub::AttachedClusters for AttachedClusters {
    async fn create_attached_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/attachedClusters", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn import_attached_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/attachedClusters:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::GenerateAttachedClusterAgentTokenResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.attached_cluster)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:generateAttachedClusterAgentToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.attached_cluster),
                        "attached_cluster",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
...
impl super::stub::AwsClusters for AwsClusters {
    async fn create_aws_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/awsClusters", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_aws_cluster_agent_token(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.aws_cluster)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:generateAwsClusterAgentToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_aws_access_token(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateAwsAccessToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_aws_node_pool(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/awsNodePools", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn get_aws_open_id_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/.well-known/openid-configuration", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::AzureClusters for AzureClusters {
    async fn create_azure_client(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/azureClients", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_azure_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/azureClusters", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_azure_cluster_agent_token(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.azure_cluster)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:generateAzureClusterAgentToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.azure_cluster),
                        "azure_cluster",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn generate_azure_access_token(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateAzureAccessToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_azure_node_pool(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/azureNodePools", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
