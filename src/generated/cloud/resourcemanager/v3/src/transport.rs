    ...
    async fn get_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:getIamPolicy", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn set_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:setIamPolicy", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn test_iam_permissions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v3/{}:testIamPermissions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
