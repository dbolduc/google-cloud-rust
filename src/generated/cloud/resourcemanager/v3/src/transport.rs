...
impl super::stub::Folders for Folders {
    ...
    async fn search_folders(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/folders:search",);
...
impl super::stub::Organizations for Organizations {
    ...
    async fn search_organizations(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/organizations:search",);
...
impl super::stub::Projects for Projects {
    ...
    async fn search_projects(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/projects:search",);
...
impl super::stub::TagBindings for TagBindings {
    async fn list_tag_bindings(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/tagBindings",);
    ...
    async fn list_effective_tags(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/effectiveTags",);
...
impl super::stub::TagKeys for TagKeys {
    ...
    async fn get_namespaced_tag_key(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/tagKeys/namespaced",);
...
impl super::stub::TagValues for TagValues {
    ...
    async fn get_namespaced_tag_value(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v3/tagValues/namespaced",);
