    ...
    async fn check_onboarding_status(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:checkOnboardingStatus", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_entitlements(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/entitlements", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn search_entitlements(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/entitlements:search", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn search_grants(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/grants:search", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
