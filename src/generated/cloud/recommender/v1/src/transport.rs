    ...
    async fn mark_insight_accepted(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:markAccepted", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn list_recommendations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/recommendations", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn mark_recommendation_dismissed(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:markDismissed", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn mark_recommendation_claimed(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:markClaimed", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn mark_recommendation_succeeded(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:markSucceeded", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn mark_recommendation_failed(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:markFailed", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
