    ...
    async fn create_scan_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/scanConfigs", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_crawled_urls(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/crawledUrls", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_finding_type_stats(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/findingTypeStats", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
