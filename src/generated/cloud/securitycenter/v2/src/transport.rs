    ...
    ) -> Result<gax::response::Response<crate::model::BatchCreateResourceValueConfigsResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/resourceValueConfigs:batchCreate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn bulk_mute_findings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/findings:bulkMute", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_big_query_export(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/bigQueryExports", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_mute_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/muteConfigs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_notification_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/notificationConfigs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn group_findings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/findings:group", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_attack_paths(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/attackPaths", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_resource_value_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/resourceValueConfigs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_valued_resources(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/valuedResources", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
