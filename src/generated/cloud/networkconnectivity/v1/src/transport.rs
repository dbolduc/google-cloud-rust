    ...
    async fn list_service_connection_maps(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceConnectionMaps", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_service_connection_policies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceConnectionPolicies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_service_classes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceClasses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_service_connection_tokens(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceConnectionTokens", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
            ...
            .or_else(|| {
                ...
                if !matches(
                    ...
                    &[
                        ...
                        Segment::Literal("global"),
                        Segment::Literal("/"),
                        Segment::Literal("policyBasedRoutes"),
                        Segment::Literal("/"),
                        Segment::SingleWildcard,
                    ],
                ) {
...
impl super::stub::HubService for HubService {
    ...
    async fn update_hub(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.hub.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.hub.as_ref()).map(|m| &m.name),
                        "hub.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn list_hub_spokes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:listSpokes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn query_hub_status(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:queryStatus", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_spoke(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.spoke.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.spoke.as_ref()).map(|m| &m.name),
                        "spoke.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn reject_hub_spoke(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:rejectSpoke", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn accept_hub_spoke(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:acceptSpoke", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn accept_spoke_update(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:acceptSpokeUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reject_spoke_update(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:rejectSpokeUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_route_tables(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/routeTables", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_policy_based_routes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/policyBasedRoutes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
