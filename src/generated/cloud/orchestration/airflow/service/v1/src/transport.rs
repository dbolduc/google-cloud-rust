    ...
    async fn create_environment(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/environments", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn execute_airflow_command(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:executeAirflowCommand", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn stop_airflow_command(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:stopAirflowCommand", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn poll_airflow_command(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:pollAirflowCommand", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn check_upgrade(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:checkUpgrade", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_user_workloads_secret(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/userWorkloadsSecrets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_user_workloads_config_map(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/userWorkloadsConfigMaps", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn save_snapshot(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:saveSnapshot", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn load_snapshot(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:loadSnapshot", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn database_failover(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:databaseFailover", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_database_properties(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchDatabaseProperties", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_image_versions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/imageVersions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
