...
impl super::stub::DataMigrationService for DataMigrationService {
    async fn list_migration_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/migrationJobs", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn generate_ssh_script(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.migration_job)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:generateSshScript", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.migration_job),
                        "migration_job",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn generate_tcp_proxy_script(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:generateTcpProxyScript", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_connection_profiles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/connectionProfiles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_conversion_workspaces(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/conversionWorkspaces", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_mapping_rule(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/mappingRules", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_mapping_rules(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/mappingRules:import", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn describe_database_entities(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.conversion_workspace)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:describeDatabaseEntities", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.conversion_workspace),
    ...
    async fn search_background_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:searchBackgroundJobs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::DescribeConversionWorkspaceRevisionsResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:describeConversionWorkspaceRevisions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_static_ips(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:fetchStaticIps", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
