...
impl super::stub::VmwareEngine for VmwareEngine {
    async fn list_private_clouds(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/privateClouds", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_external_addresses(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/externalAddresses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    ) -> Result<gax::response::Response<crate::model::FetchNetworkPolicyExternalAddressesResponse>>
    {
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.network_policy)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:fetchExternalAddresses", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.network_policy),
                        "network_policy",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
        ...
        let path = None
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.subnet.as_ref()).map(|m| &m.name),
                        "subnet.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn list_external_access_rules(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/externalAccessRules", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_logging_servers(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/loggingServers", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn show_nsx_credentials(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.private_cloud)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v1/{}:showNsxCredentials", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).map(|m| &m.private_cloud),
                        "private_cloud",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn show_vcenter_credentials(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:showVcenterCredentials", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reset_nsx_credentials(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resetNsxCredentials", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn reset_vcenter_credentials(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:resetVcenterCredentials", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_network_peerings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/networkPeerings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_peering_routes(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/peeringRoutes", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_hcx_activation_key(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/hcxActivationKeys", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_network_policies(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/networkPolicies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_management_dns_zone_bindings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/managementDnsZoneBindings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_vmware_engine_network(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/vmwareEngineNetworks", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_private_connection(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/privateConnections", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
