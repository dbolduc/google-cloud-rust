...
impl super::stub::LanguageService for LanguageService {
    async fn analyze_sentiment(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v2/documents:analyzeSentiment",);
    ...
    async fn analyze_entities(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v2/documents:analyzeEntities",);
    ...
    async fn classify_text(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v2/documents:classifyText",);
    ...
    async fn moderate_text(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v2/documents:moderateText",);
    ...
    async fn annotate_text(
        ...
        let builder = None
            .or_else(|| {
                let path = format!("/v2/documents:annotateText",);
