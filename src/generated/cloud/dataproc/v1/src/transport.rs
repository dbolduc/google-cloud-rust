    ...
    async fn create_autoscaling_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/autoscalingPolicies", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_cluster(
        ...
        let path = None
            .or_else(|| {
                ...
                let arg2 = Some(&req).map(|m| &m.region)?;
                ...
                Some(format!("/v1/projects/{}/regions/{}/clusters", arg1, arg2,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_cluster(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.project_id)?;
                let arg2 = Some(&req).map(|m| &m.region)?;
                let arg3 = Some(&req).map(|m| &m.cluster_name)?;
                if !matches(arg1, &[Segment::SingleWildcard]) {
                    return None;
                }
                if !matches(arg2, &[Segment::SingleWildcard]) {
    ...
    async fn get_job(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.project_id)?;
                let arg2 = Some(&req).map(|m| &m.region)?;
                let arg3 = Some(&req).map(|m| &m.job_id)?;
                if !matches(arg1, &[Segment::SingleWildcard]) {
                    return None;
                }
                if !matches(arg2, &[Segment::SingleWildcard]) {
    ...
    async fn list_jobs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/projects/{}/regions/{}/jobs", arg1, arg2,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_node_group(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/nodeGroups", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_session_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/sessionTemplates", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_workflow_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/workflowTemplates", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn instantiate_workflow_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:instantiate", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(
    ...
    async fn instantiate_inline_workflow_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/workflowTemplates:instantiateInline", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
