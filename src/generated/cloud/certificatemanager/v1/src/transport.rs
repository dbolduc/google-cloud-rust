    ...
    async fn list_certificate_maps(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/certificateMaps", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_certificate_map_entries(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/certificateMapEntries", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_dns_authorizations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/dnsAuthorizations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_certificate_issuance_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/certificateIssuanceConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_trust_configs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/trustConfigs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
