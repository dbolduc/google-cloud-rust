...
impl super::stub::WebRiskService for WebRiskService {
    async fn compute_threat_list_diff(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/threatLists:computeDiff",)))
            .ok_or_else(|| {
    ...
    async fn search_uris(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/uris:search",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn search_hashes(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/hashes:search",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn create_submission(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/submissions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn submit_uri(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/uris:submit", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
