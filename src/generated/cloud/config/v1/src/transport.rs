    ...
    async fn export_deployment_statefile(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:exportState", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn import_statefile(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:importState", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn delete_statefile(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:deleteState", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn export_lock_info(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:exportLock", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_terraform_versions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/terraformVersions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
