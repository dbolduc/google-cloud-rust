    ...
    async fn submit_build(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/builds:submit", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn list_executions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/executions", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
