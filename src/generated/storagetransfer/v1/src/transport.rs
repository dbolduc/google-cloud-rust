...
impl super::stub::StorageTransferService for StorageTransferService {
    async fn get_google_service_account(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/googleServiceAccounts/{}", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn create_transfer_job(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/transferJobs",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn update_transfer_job(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.job_name)?;
                if !matches(
                    arg1,
                    &[
    ...
    async fn create_agent_pool(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/projects/{}/agentPools", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_operations(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.name)?;
                if !matches(arg1, &[Segment::Literal("transferOperations")]) {
                    return None;
                }
                Some(format!("/v1/{}", arg1,))
            })
