...
impl super::stub::RepositoryManager for RepositoryManager {
    ...
    async fn create_repository(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/repositories", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn batch_create_repositories(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/repositories:batchCreate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_read_write_token(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.repository)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:accessReadWriteToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_read_token(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:accessReadToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_linkable_repositories(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.connection)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
                ...
                Some(format!("/v2/{}:fetchLinkableRepositories", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn fetch_git_refs(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:fetchGitRefs", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
