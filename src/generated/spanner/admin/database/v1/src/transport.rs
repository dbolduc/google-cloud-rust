...
impl super::stub::DatabaseAdmin for DatabaseAdmin {
    ...
    async fn update_database_ddl(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.database)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
    ...
    async fn copy_backup(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backups:copy", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_database_operations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/databaseOperations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_backup_operations(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/backupOperations", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_database_roles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/databaseRoles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn add_split_points(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}:addSplitPoints", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
