...
impl super::stub::DlpService for DlpService {
    async fn inspect_content(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/content:inspect", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn redact_image(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/image:redact", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn deidentify_content(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/content:deidentify", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn reidentify_content(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/content:reidentify", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_info_types(
        ...
        let path = None
            .or_else(|| Some(format!("/v2/infoTypes",)))
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
                    arg1,
    ...
    async fn create_inspect_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/inspectTemplates", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_deidentify_template(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/deidentifyTemplates", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_job_trigger(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/jobTriggers", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn hybrid_inspect_job_trigger(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:hybridInspect", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_discovery_config(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/discoveryConfigs", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_stored_info_type(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/storedInfoTypes", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_project_data_profiles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/projectDataProfiles", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_table_data_profiles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/tableDataProfiles", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_column_data_profiles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/columnDataProfiles", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn list_file_store_data_profiles(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/fileStoreDataProfiles", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn create_connection(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/connections", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
    ...
    async fn search_connections(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/connections:search", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.parent)?;
                if !matches(
