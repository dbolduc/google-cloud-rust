...
pub mod firestore_admin {
    ...
    /// The request builder for a FirestoreAdmin::create_user_creds call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::get_user_creds call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::list_user_creds call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::enable_user_creds call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::disable_user_creds call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::reset_user_password call.
    #[derive(Clone, Debug)]
    ...
    /// The request builder for a FirestoreAdmin::delete_user_creds call.
    #[derive(Clone, Debug)]
