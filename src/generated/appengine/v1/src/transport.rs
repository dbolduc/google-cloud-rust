...
impl super::stub::Applications for Applications {
    ...
    async fn create_application(
        ...
        let path = None.or_else(|| Some(format!("/v1/apps",))).ok_or_else(|| {
            let mut paths = Vec::new();
            {
                let builder = PathMismatchBuilder::default();
                paths.push(builder.build());
    ...
    async fn list_ingress_rules(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/firewall/ingressRules", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
            ...
            .or_else(|| {
                ...
                if !matches(
                    ...
                    &[
                        ...
                        Segment::SingleWildcard,
                        Segment::Literal("/"),
                        Segment::Literal("firewall"),
                        Segment::Literal("/"),
                        Segment::Literal("ingressRules"),
                    ],
                ) {
                    return None;
                }
                Some(format!("/v1/{}:batchUpdate", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_authorized_domains(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/authorizedDomains", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_authorized_certificates(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/authorizedCertificates", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn list_domain_mappings(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/domainMappings", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
