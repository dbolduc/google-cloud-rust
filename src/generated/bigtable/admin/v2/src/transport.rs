    ...
    async fn create_app_profile(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/appProfiles", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn get_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:getIamPolicy", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn set_iam_policy(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:setIamPolicy", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn test_iam_permissions(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:testIamPermissions", arg1,))
            })
            .or_else(|| {
                let arg1 = Some(&req).map(|m| &m.resource)?;
                if !matches(
    ...
    async fn list_hot_tablets(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/hotTablets", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_logical_view(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/logicalViews", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn create_materialized_view(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/materializedViews", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
...
impl super::stub::BigtableTableAdmin for BigtableTableAdmin {
    ...
    async fn create_table_from_snapshot(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/tables:createFromSnapshot", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn update_table(
        ...
        let path = None
            .or_else(|| {
                let arg1 = Some(&req).and_then(|m| m.table.as_ref()).map(|m| &m.name)?;
                if !matches(
                    arg1,
                    &[
                        Segment::Literal("projects"),
            ...
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
                    let builder = builder.maybe_add_match_error(
                        Some(&req).and_then(|m| m.table.as_ref()).map(|m| &m.name),
                        "table.name",
                        &[
                            Segment::Literal("projects"),
                            Segment::Literal("/"),
    ...
    async fn create_authorized_view(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/authorizedViews", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn modify_column_families(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:modifyColumnFamilies", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn drop_row_range(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:dropRowRange", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn generate_consistency_token(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:generateConsistencyToken", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn check_consistency(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}:checkConsistency", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn restore_table(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/tables:restore", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn copy_backup(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v2/{}/backups:copy", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
