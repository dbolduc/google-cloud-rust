...
impl super::stub::Iam for Iam {
    async fn list_service_accounts(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/serviceAccounts", arg1,))
            })
            .ok_or_else(|| {
    ...
    async fn upload_service_account_key(
        ...
        let path = None
            .or_else(|| {
                ...
                Some(format!("/v1/{}/keys:upload", arg1,))
            })
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
    ...
    async fn query_grantable_roles(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/roles:queryGrantableRoles",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn query_testable_permissions(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/permissions:queryTestablePermissions",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn query_auditable_services(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/iamPolicies:queryAuditableServices",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
    ...
    async fn lint_policy(
        ...
        let path = None
            .or_else(|| Some(format!("/v1/iamPolicies:lintPolicy",)))
            .ok_or_else(|| {
                let mut paths = Vec::new();
                {
                    let builder = PathMismatchBuilder::default();
