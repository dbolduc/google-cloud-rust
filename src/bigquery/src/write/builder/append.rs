...
#[cfg(test)]
mod tests {
    use super::super::super::dispatcher::Dispatcher;
    use super::super::super::entry::StreamEntry;
    use super::super::super::pool::StreamPool;
    use super::super::super::runner::WriteRequest;
